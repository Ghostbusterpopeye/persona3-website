...
const ITEMS = [
  ...
  { id: "resume",  label: "PROJECTS",      page: "resume",  fontSize: 66, offsetX: 20, offsetY: 8,  skew: -11, skewY: -10 },
  ...
  { id: "sideproj",label: "CONTACT",       page: "sideproj",fontSize: 56, offsetX: 10, offsetY: 6,  skew: -4,  skewY: 7   },
];
